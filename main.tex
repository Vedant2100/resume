...
\vspace{-5pt}
\resumeItemListStart
\resumeItem{Benchmarked frontier LLMs against adversarial attack vectors mapped to the \textbf{OWASP LLM Top 10} and \textbf{MITRE ATLAS}, designing multi-step, multi-agent red-team suites and curating the proprietary datasets that train CompFly's detection and defense models.}
\vspace{-3pt}
