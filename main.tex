...
\end{tabular*}\vspace{-7pt}
\resumeItemListStart
\resumeItem{Engineered \textbf{agentic observability} for the agent-monitoring platform: a nested \textbf{OpenTelemetry} span tree tracing each agent's full causal trajectory -- agent turns, tool calls, and sub-agent handoffs with token-level cost -- normalized across leading AI and agent frameworks.}
\vspace{-3pt}
