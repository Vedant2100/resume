...
\vspace{-3pt}
\resumeItem{Developed comprehensive \textbf{Power BI reports} for share gain attribution, portfolio performance, competitor dynamics (top share gaps, vulnerability trends, consecutive share losses), BCG-style prioritization, and annual revenue/volume dashboards with executive summaries.}
  \resumeItemListEnd
\vspace{-5pt}
\vspace{-5pt}
%-----------PROJECTS-----------
