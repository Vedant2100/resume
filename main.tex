...
\vspace{-5pt}
\resumeItemListStart
\resumeItem{Evaluate frontier models (GPT, Claude, Gemini, Llama, Mistral) on adversarial attack vectors and design \textbf{benchmark suites} for multi-step, multi-agent scenarios, mapping security gaps in frontier LLMs and autonomous agents.}
\vspace{-3pt}
\resumeItem{Survey security literature, red-team reports, and the \textbf{OWASP LLM Top 10} to surface emerging threats, building the proprietary datasets and failure-taxonomy reports that power CompFly's detection and defense models.}
\vspace{-3pt}
